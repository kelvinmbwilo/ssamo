                ...
                <div class="container ">
                    <div class="row">
                        <div class="col-sm-5"><br/>
                            <div class="flexslider" data-controlnav="true">
                                <ul class="slides">
                                    ...
                                    <li>
                                        <img src='{{ asset("uploads/pictures/{$photo->image}") }}' class="img-rounded" alt="title" style="height: 350px">
                                    </li>
                                    @endforeach
                                </ul>
                            </div>
                        ...
                        <div class="col-sm-7" >
                            ...
                            <p style="font-size: 18px;font-family:'Open Sans', Calibri, Candara, Arial, sans-serif; color: #FDF5C2">SSAMO (pronounced 'samo' stands for Stuff Souls are Made Of) is inspired by a Swahili slang term 'Vitu Roho Inapenda'. SSAMO Media formerly Studio SSAMO is a Dar Es Salaam based creative agency that offers custom tailored solutions to individuals and small to mid-sized companies.

                                We specialized in high quality photography, graphic design and video production services at affordable prices.

                            </p><p style="font-size: 18px;color: #FDF5C2"> Whether you're: in need of capturing celebrating a special moment in your life, starting a new business, looking for promotional material for your event or in need of a video produced; one of our many packages will help solve your problem.
                    ...
                    <div class="row visible-md hidden-xs hidden-sm" style="margin-top: 10px">
                        <?php
                        $photos1  = Picture::orderBy('created_at','DESC')->limit(11)->get();
                        ?>
