...
<div class="bootstrap-admin-panel-content">
   @if(Portfolio::all()->count() == 0)
    <h3>There are no Portfolios posted</h3>
    @else
    ...
    <tbody>
    <?php $i=1; ?>
    @foreach(Portfolio::all() as $us)
    <tr>
        <td>{{ $i++ }}</td>
        <td><img src='{{ asset("uploads/portfolios/{$us->image}") }}' style="width: 70px; height: 70px"/></td>
        <td >{{ $us->title }}</td>
...
<script>
    ...
    $(document).ready(function() {
        $('#example2').dataTable({
            "fnDrawCallback": function( oSettings ) {
                ...
                $(".edituser").click(function(){
                    ...
                    $(".modal-body").load("<?php echo url("admin/portfolio/edit") ?>/"+id1);
                ...
                $(".deletevaccine").click(function(){
                    ...
                    $("#yes").click(function(){
                        ...
                        $.post("<?php echo url('admin/portfolio/delete') ?>/"+id1,function(data){
        ...
        $(".add").click(function(){
            ...
            $("#myModal").modal("show");
            $(".modal-body").html("<h3><i class='fa fa-spin fa-spinner '></i><span>loading...</span><h3>");
            $(".modal-body").load("<?php echo url("admin/portfolio/add/") ?>");
            $("#myModal").on('hidden.bs.modal',function(){
                $("#myModal").remove();
            })
