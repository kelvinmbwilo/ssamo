...
<div class="bootstrap-admin-panel-content">
   @if(Category::all()->count() == 0)
    <h3>There are no defined categories</h3>
    @else
...
<script>
    ...
    $(document).ready(function() {
        $('#example2').dataTable({
            "fnDrawCallback": function( oSettings ) {
                ...
                $(".edituser").click(function(){
                    ...
                    modal+= '<h2 class="modal-title" id="myModalLabel">Update Category Information</h2>';
                    modal+= '</div>';
                    ...
                    $(".modal-body").load("<?php echo url("admin/category/edit") ?>/"+id1);
                ...
                $(".deletevaccine").click(function(){
                    ...
                    $("#yes").click(function(){
                        ...
                        $.post("<?php echo url('admin/category/delete') ?>/"+id1,function(data){
        ...
        $(".add").click(function(){
            ...
            modal+= '<div class="modal-header">';
            modal+= '<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>';
            modal+= '<h2 class="modal-title" id="myModalLabel">Add New  Photo Category</h2>';
            modal+= '</div>';
            modal+= '<div class="modal-body">';
            modal+= ' </div>';
            modal+= '</div>';
            ...
            $("#myModal").modal("show");
            $(".modal-body").html("<h3><i class='fa fa-spin fa-spinner '></i><span>loading...</span><h3>");
            $(".modal-body").load("<?php echo url("admin/category/add/") ?>");
            $("#myModal").on('hidden.bs.modal',function(){
                $("#myModal").remove();
            })
